...
namespace MicroListings
{
    public partial class frmMain : Form
    {
        ...
        {
            string filename = @"S:\eCommerce\Shipping\textfiles\Listings" + System.DateTime.Today.Month + "_" + System.DateTime.Today.Day + "_" + System.DateTime.Today.Year + "_" + System.DateTime.Now.Hour + "_" + System.DateTime.Now.Minute + ".txt";
            if (!(System.IO.File.Exists(filename))) { System.IO.File.Copy(@"S:\eCommerce\Shipping\textfiles\amazon_feed.txt", filename); }
            
            string filename2 = @"S:\eCommerce\Shipping\textfiles\Listings" + System.DateTime.Today.Month + "_" + System.DateTime.Today.Day + "_" + System.DateTime.Today.Year + "_" + System.DateTime.Now.Hour + "_" + System.DateTime.Now.Minute + "_b2b.txt";
            if (!(System.IO.File.Exists(filename2))) { System.IO.File.Copy(@"S:\eCommerce\Shipping\textfiles\b2b.txt", filename2); }
